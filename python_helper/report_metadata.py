...
def calculation_meta(input_data: Mapping[str, Any]) -> dict[str, Any]:
    """Build an auditable report header without embedding mutable business logic."""
    ...
    revision = os.getenv("IPBOX_CODE_REVISION") or os.getenv("GITHUB_SHA") or "unavailable"
