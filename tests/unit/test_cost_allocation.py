import pytest
from python_helper.ipbox_calculator import allocate_costs_monthly, CostItem
...
class TestCostAllocation:
    ...
    def test_allocation_order(self):
        ...
        # W = 90%
        res = allocate_costs_monthly(items, w_coefficient=90.0)
    ...
    def test_direct_ip_costs(self):
        ...
        # W = 50%
        res = allocate_costs_monthly(items, w_coefficient=50.0, ip_direct_costs=ip_direct)
