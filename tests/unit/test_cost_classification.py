...
class TestCostClassification:
    ...
    @pytest.mark.parametrize(
        "description,amount,social_security_in_kpir,expected_basket",
        [
    ...
    def test_basic_classification(
        self, description, amount, social_security_in_kpir, expected_basket
    ):
        item = CostItem(description=description, amount=amount)
        result = classify_cost(
            item, social_security_in_kpir=social_security_in_kpir, health_insurance_in_kpir=True
        )
